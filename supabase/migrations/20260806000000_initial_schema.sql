-- ========================================================
-- MIGRATION INICIAL BANCO DE DADOS GRANA+ (SUPABASE)
-- Data: 2026-08-06
-- Descrição: Criação de tabelas, relacionamentos, índices, 
...
CREATE TABLE IF NOT EXISTS public.assets (
    ...
    user_id UUID NOT NULL REFERENCES public.profiles(id) ON DELETE CASCADE,
    name TEXT NOT NULL,
    category TEXT NOT NULL, -- e.g. 'Contas', 'Investimentos', 'Imóveis', 'Veículos', 'Outros Bens'
